...
const plans = [
  {
    ...
    features: ["20 invoices / month", "20 quotations / month", "1 team member", "5 OCR scans / month", "3 clients", "M-Pesa payments", "Multi-currency invoicing", "Payroll & payslips", "Classic template", "No AI features"],
  ...
  },
  {
    ...
    features: ["200 invoices / month", "150 quotations / month", "3 team members", "10 OCR scans / month", "20 clients", "M-Pesa + Paystack", "Multi-currency invoicing", "Payroll & payslips", "Email invoices", "Client portal", "Products catalog", "Supplier price requests", "Job profitability tracking", "3-month reports", "15 AI calls / month"],
  ...
  },
  {
    ...
    features: ["Unlimited invoices", "Unlimited quotations", "15 team members", "100+ OCR scans / month", "Unlimited clients", "Unlimited projects", "Multi-currency invoicing", "Payroll & payslips", "White-label branding", "Priority support", "All 3 templates", "Full history reports", "Supplier price comparison", "Job profitability tracking", "Unlimited AI calls"],
    cta: "Go Premium",
    highlight: false,
  },
];
