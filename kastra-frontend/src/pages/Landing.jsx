...
const features = [
  ...
  },
  {
    ...
    desc: "Auto-suggest invoice line items from past history, scan receipts on invoices and quotations to pre-fill line items instantly, get a 30-day cash flow forecast, generate quotation descriptions from bullet points, and score client payment risk — all powered by Claude AI.",
  },
  {
    icon: Wallet,
